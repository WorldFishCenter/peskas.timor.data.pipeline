...
aggregated$month %>%
  ...
  labs(
    ...
    subtitle = "Except for 2019, the total revenue is seasonal, showing the highest\nduring autumn and winter."
  ) +
...
effort_caption <- paste0("The average trip duration of Peskas' boats is of ",
                         ...
                         " hours.\nAs there are on average ", round(mean(effort_dat$n, na.rm=TRUE),0),
                         " trips each month,\nthe monthly fishing effort is about ",
...
stock_caption <- paste0(stock_dat[1,1]$comm_name, " represent the most important species in terms of overall stock,\ntogether with ",
                        ...
                        ",\naccount for ", round(stock_dat[4,4],1), "% of the total stock." )
...
```{r, echo=FALSE, warning=FALSE, eval=FALSE, message=FALSE, fig.height=4, fig.width=8}
validated_landings %>%
  dplyr::mutate(month_date=lubridate::floor_date(.data$landing_date,
                                                 "month",
                                                 week_start = 7),
