...
```{r echo=FALSE, fig.height=3, fig.width=10, message=FALSE, warning=FALSE, out.height="100%",out.width="100%"}
gear_plot <-
tidyr::tibble(gear_id=metadata$gear_types$gear_id,
  ...
  labs(
    ...
    subtitle="The Peskas' fleet is composed of a total of 451 boats, most of them  motorised. More than 90% of the boats\nare equipped with hand line and long line while about 6% equip spear guns."
  )+
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5, fig.width=10,out.height="100%",out.width="100%"}
validated_landings %>%
...
validated_landings %>%
  ...
  labs(
    ...
    title = "Interannual distribution fishing effort",
...
validated_landings %>%
    ...
    dplyr::summarise(monthly_effort=sum(trip_duration,na.rm=TRUE),
     ...
     labs(
       ...
       color="Year",
       subtitle = "Except for 2019, where there appears to be a greater fishing\neffort in proportion to the number of fishing trips, the relationship\nbetween the two is stable throughout Peskas' period of activity."
     )+
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=9, fig.width=9,out.height="100%",out.width="100%"}
  ...
  labs(
    ...
    subtitle = "Sardines represent the most important species in terms of overall stock,\ntogether with Mackerel, Fusilliers and flying fishes account for about 40% of the total stock."
  ) +
  theme(
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=7, fig.width=9,out.height="100%",out.width="100%"}
dplyr::left_join(catch, trips, by = "trip_id") %>%
  dplyr::mutate(month_date=lubridate::floor_date(.data$landing_date,
                                                 "month",
                                                 week_start = 7),
...
```{r, echo=FALSE, warning=FALSE, fig.height=12, fig.width=8.5,out.height="100%",out.width="100%"}
rank_catch <-
  catch %>%
