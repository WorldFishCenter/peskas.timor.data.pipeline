# Contributing to peskas.timor.data.pipeline

This outlines how to propose a change to peskas.timor.data.pipeline. For
more detailed info about contributing to this, and other tidyverse
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("WorldFishCenter/peskas.timor.data.pipeline", fork = TRUE)`.
...
Please note that the peskas.timor.data.pipeline project is released with
a [Contributor Code of
Conduct](https://worldfishcenter.github.io/peskas.timor.data.pipeline/CODE_OF_CONDUCT.md).
